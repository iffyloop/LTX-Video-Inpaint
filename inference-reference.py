...
VAE_DIR = Path("/root/models/Lightricks--LTX-Video/vae")
UNET_PATH = Path("/root/models/konakona--ltxvideo_q8")
SCHEDULER_DIR = Path("/root/models/Lightricks--LTX-Video/scheduler")
TEXT_ENCODER_DIR = Path("/root/models/Lightricks--LTX-Video")
TOKENIZER_DIR = Path("/root/models/PixArt-alpha--PixArt-XL-2-1024-MS")
...
def main():
    ...
    parser.add_argument("--unet_path", type=str, default="konakona/ltxvideo_q8")
    parser.add_argument(
        "--input_video_path",
        type=str,
    ...
    parser.add_argument(
        "--transformer_type", default="q8_kernels", choices=["q8_kernels", "diffusers"]
    )
